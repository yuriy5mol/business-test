...
### 🔑 Управление и доступ
Для входа в панель управления перейдите по адресу: `/admin` (или `http://ваш-домен.com/admin`). 
- **Локально**: `http://localhost/admin`
- **Продакшн**: Используйте зашифрованное соединение HTTPS.

> [!NOTE]
> Прямой ссылки с главной страницы на админку нет специально, чтобы не привлекать внимание ботов. Рекомендуется сохранить адрес в закладки.
